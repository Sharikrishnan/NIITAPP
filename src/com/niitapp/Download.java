...
public class Download extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		tv1.setText("Activating Net-book");
		tv2.setText("Install Cloud Courseware System");
		tv3.setText("Device Registration Utility");
		tv4.setText("Online Product Support Utility");
		tv5.setText("NIITiM 1.0.0.1");
		tv6.setText("Version Management System");
		tv7.setText("ISAS Assessment Card");
